...
public class TrainingCourseDAO implements AutoCloseable {
    ...
    public TrainingCourseDAO() throws SQLException, ClassNotFoundException {
        this.connection = DatabaseConnection.getDatabaseConnection();
    }

    // =================== CRUD Operations ===================

    public Optional<Integer> createTrainingCourse(TrainingCourse trainingCourse) throws SQLException {
    ...
    public boolean updateTrainingCourse(TrainingCourse trainingCourse) throws SQLException {
        validateTrainingCourse(trainingCourse);
