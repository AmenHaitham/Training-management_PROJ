document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchSessions() {
        fetch(`${API_CONFIG.BASE_URL}/tms/session`)
            .then(res => res.json())
            .then(data => {
                allSessions = data;
    ...
    function fetchMaterials() {
        fetch(`${API_CONFIG.BASE_URL}/tms/materials`)
            .then(res => res.json())
            .then(data => {
                allMaterials = data;
                filterMaterials();
    ...
    function saveMaterial() {
        ...
        const url = isEdit ? `${API_CONFIG.BASE_URL}/tms/materials/${materialId}` : '/tms/materials';
    ...
    function deleteMaterial(id) {
        fetch(`${API_CONFIG.BASE_URL}/tms/materials/${id}`, { method: 'DELETE' })
    ...
    function viewMaterial(id) {
        window.open(`${API_CONFIG.BASE_URL}/tms/materials/${id}/view`, '_blank');
    }

    function downloadMaterial(id) {
        window.location.href = `${API_CONFIG.BASE_URL}/tms/materials/${id}/file`;
    }
