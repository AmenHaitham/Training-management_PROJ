document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchCourses() {
        return fetch(`${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.COURSES}`)
            .then(response => {
                if (!response.ok) {
    ...
    function handleSaveCourse() {
        ...
        const url = isEditMode ? `${API_CONFIG.BASE_URL}/tms/courses/${courseId}` : `${API_CONFIG.BASE_URL}/tms/courses`;
    ...
    function deleteCourse(courseId) {
        ...
        fetch(`${API_CONFIG.BASE_URL}/tms/courses/${courseId}`, {
            method: 'DELETE'
        })
        .then(response => {
            if (!response.ok) {
