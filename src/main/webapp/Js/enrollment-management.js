document.addEventListener('DOMContentLoaded', function () {
    ...
    Promise.all([
        fetch(`${API_CONFIG.BASE_URL}/tms/enrollments`).then(handleResponse),
        fetch(`${API_CONFIG.BASE_URL}/tms/trainings`).then(handleResponse),
        fetch(`${API_CONFIG.BASE_URL}/tms/users`).then(handleResponse) // Changed from 'users' to 'trainees'
    ])
...
async function handleResponse(response) {
    ...
    async function saveEnrollment() {
        ...
        const base = `${API_CONFIG.BASE_URL}/tms`;
    ...
    async function deleteEnrollment(id) {
        ...
        try {
            const response = await fetch(`${API_CONFIG.BASE_URL}/tms/enrollments/${id}`, { 
                method: 'DELETE' 
            });
