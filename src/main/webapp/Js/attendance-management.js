// Wait for DOM and API_CONFIG to be available
document.addEventListener('DOMContentLoaded', function() {
    // Check if API_CONFIG is available
    if (typeof API_CONFIG === 'undefined') {
        console.error('API_CONFIG is not defined. Make sure config.js is loaded before attendance-management.js');
        return;
    }

    // Initialize API_CONFIG if needed
    if (!API_CONFIG.BASE_URL) {
        console.error('API_CONFIG.BASE_URL is not defined');
        return;
    }

    // Check if API_CONFIG.ENDPOINTS is defined
    if (!API_CONFIG.ENDPOINTS || !API_CONFIG.ENDPOINTS.ATTENDANCE) {
        console.error('API_CONFIG.ENDPOINTS or API_CONFIG.ENDPOINTS.ATTENDANCE is not defined');
        return;
    }

    console.log('API_CONFIG loaded:', API_CONFIG);
    console.log('BASE_URL:', API_CONFIG.BASE_URL);
    console.log('ATTENDANCE endpoint:', API_CONFIG.ENDPOINTS.ATTENDANCE);
    ...
    function fetchAttendance() {
        ...
        .then(data => {
            ...
            console.log('Processed attendance:', allAttendance);
    ...
    function fetchSessions() {
        const url = `${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.SESSION}`;
    ...
    function saveAttendance() {
        ...
        const baseUrl = `${API_CONFIG.BASE_URL}/tms/attendance`;
    ...
    function deleteAttendance(attendanceId) {
        fetch(`${API_CONFIG.BASE_URL}/tms/attendance/${attendanceId}`, {
            method: 'DELETE'
        })
        .then(response => {
            if (!response.ok) {
